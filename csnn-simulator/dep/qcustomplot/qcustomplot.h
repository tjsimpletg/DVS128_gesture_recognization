...
public:
	...
	QCPGrid(const QCPGrid& that) = delete;
	QCPGrid& operator=(const QCPGrid& that) = delete;
...
public:
	...
	QCPAxisPainterPrivate(const QCPAxisPainterPrivate& that) = delete;

	virtual ~QCPAxisPainterPrivate();


	QCPAxisPainterPrivate& operator=(const QCPAxisPainterPrivate& that) = delete;
...
protected:
	...
	{
		TickLabelData() :
			basePart(), expPart(), suffixPart(),
			baseBounds(), expBounds(), suffixBounds(), totalBounds(), rotatedTotalBounds(),
			baseFont(), expFont() {
...
public:
  ...
  */
	...
	QCustomPlot(const QCustomPlot& that) = delete;
	virtual ~QCustomPlot();
	QCustomPlot& operator=(const QCustomPlot& that) = delete;
	// getters:
...
public:
	...
	QCPPlottableLegendItem(const QCPPlottableLegendItem& that) = delete;

	QCPPlottableLegendItem& operator=(const QCPPlottableLegendItem& that) = delete;
...
public:
	...
	QCPColorScaleAxisRectPrivate(const QCPColorScaleAxisRectPrivate& that) = delete;
	QCPColorScaleAxisRectPrivate& operator=(const QCPColorScaleAxisRectPrivate& that) = delete;
protected:
...
public:
  ...
  */
	...
	QCPBars(const QCPBars& that) = delete;
	virtual ~QCPBars();

	QCPBars& operator=(const QCPBars& that) = delete;
...
public:
	...
	QCPColorMap(const QCPColorMap& that) = delete;
	virtual ~QCPColorMap();
	QCPColorMap& operator=(const QCPColorMap& that) = delete;
...
public:
	...
	QCPItemStraightLine(const QCPItemStraightLine& that) = delete;
	virtual ~QCPItemStraightLine();
	QCPItemStraightLine& operator=(const QCPItemStraightLine& that) = delete;
...
public:
	...
	QCPItemLine(const QCPItemLine& that) = delete;
	virtual ~QCPItemLine();
	QCPItemLine& operator=(const QCPItemLine& that) = delete;
...
public:
	...
	QCPItemCurve(const QCPItemCurve& that) = delete;
	virtual ~QCPItemCurve();
	QCPItemCurve& operator=(const QCPItemCurve& that) = delete;
...
public:
	...
	QCPItemRect(const QCPItemRect& that) = delete;
	virtual ~QCPItemRect();
	QCPItemRect& operator=(const QCPItemRect& that) = delete;
...
public:
	...
	QCPItemText(const QCPItemText& that) = delete;
	virtual ~QCPItemText();
	QCPItemText& operator=(const QCPItemText& that) = delete;
...
public:
	...
	QCPItemEllipse(const QCPItemEllipse& that) = delete;
	virtual ~QCPItemEllipse();
	QCPItemEllipse& operator=(const QCPItemEllipse& that) = delete;
...
public:
	...
	QCPItemPixmap(const QCPItemPixmap& that) = delete;
	virtual ~QCPItemPixmap();
	QCPItemPixmap& operator=(const QCPItemPixmap& that) = delete;
...
public:
  ...
  */
	...
	QCPItemTracer(const QCPItemTracer& that) = delete;
	virtual ~QCPItemTracer();
	QCPItemTracer& operator=(const QCPItemTracer& that) = delete;
...
public:
  ...
  */
	...
	QCPItemBracket(const QCPItemBracket& that) = delete;
	virtual ~QCPItemBracket();
	QCPItemBracket& operator=(const QCPItemBracket& that) = delete;
