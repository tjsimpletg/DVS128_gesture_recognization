#ifndef _TOOL_VIDEO_FRAME_SELECTOR_H
#define _TOOL_VIDEO_FRAME_SELECTOR_H
...
namespace tool
{
     ...
     */
    class VideoFrameSelector : public InputTool
    {

    public:
        VideoFrameSelector();
        VideoFrameSelector(const std::string & video_folder_path,  size_t & frame_per_video);
