...
namespace process
{
	...
	public:
		MotionGridV1();
		MotionGridV1(std::string expName, size_t draw = 0, size_t frames_width = 0, size_t frames_height = 0, size_t frames_total = 48, size_t mg_vertical_frames = 8, size_t mg_horizontal_frames = 16, size_t scalar = 50);
