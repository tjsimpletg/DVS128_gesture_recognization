#ifndef _PROCESS_AMPLIFICATION_H
#define _PROCESS_AMPLIFICATION_H
...
namespace process
{
	 ...
	 */
	class Amplification : public UniquePassProcess
	{

	public:
		Amplification();
		Amplification(std::string expName, size_t scalar = 0, size_t draw = 0);
