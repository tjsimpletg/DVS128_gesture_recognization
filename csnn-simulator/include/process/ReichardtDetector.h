#ifndef _PROCESS_REICHARD_DETECTOR_H
#define _PROCESS_REICHARD_DETECTOR_H
...
namespace process
{
	 ...
	 */
	class ReichardtDetector : public UniquePassProcess
	{

	public:
		ReichardtDetector();
		ReichardtDetector(std::string expName, size_t draw = 0, size_t scalar = 1);
