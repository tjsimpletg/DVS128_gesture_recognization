#ifndef _PROCESS_ORIENTATION_AMPLITUDE_H
#define _PROCESS_ORIENTATION_AMPLITUDE_H
...
namespace process
{
	...
	namespace _priv
	{
		class OrientationAmplitudeHelper
		{

		public:
			OrientationAmplitudeHelper() = delete;
		};
	}
	 ...
	 */
	class OrientationAmplitude : public UniquePassProcess
	{

	public:
		OrientationAmplitude();
		OrientationAmplitude(std::string expName, size_t draw = 0, size_t scalar = 1);
